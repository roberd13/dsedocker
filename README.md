...
If you're building custom images based on the github repo, you'll need to download the tarball(s) or provide a direct link(s). To get immediate and ongoing automated access sign up for a [DataStax Academy account](https://academy.datastax.com/). You can then use your DataStax Academy credentials for [direct access](http://downloads.datastax.com/enterprise/) to point releases. 
